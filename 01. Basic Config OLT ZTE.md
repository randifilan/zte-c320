01. Basic Config OLT ZTE.md
---
1.  Show Not Register ONU in OLT 
```
show gpon onu uncfg
OnuIndex                 Sn                  State
---------------------------------------------------------------------
...
2.  Register ONU with SN Methode
```
configure terminal
...
3.  Show Running Config of Register ONU
```
...
5.  Show Receive Power in OLT/ONT
```
...
6.  Check ONU Detail Info & History
```
...
7.  Show Device Mac-address connected to ONT
```
...
10. Check Port (LAN/Wifi) Status in ONT
```
...
12. Shutdown/Enable Port in ONT
```
configure terminal 
%Info 20272: Enter configuration commands, one per line. End with CTRL/Z.
pon-onu-mng gpon-onu_1/2/2:17
...
18. Show VLAN and summary of Configure VLAN in OLT
```
show vlan summary 
